<div class="product-cart-wrap">
    <div class="product-img-action-wrap">
        ...
        <div class="product-action-1">
            ...
            <a aria-label="{{ __('Try On (AI)') }}" href="#" class="action-btn hover-up js-ai-tryon-button" data-url="{{ route('public.tryon.generate', $product->id) }}">
                <i class="fi-rs-picture"></i>
            </a>
    ...
    <div class="product-content-wrap">
        ...
        <div class="mt-30 d-flex align-items-center">
            ...
            @endif
            <a aria-label="{{ __('Try On (AI)') }}" href="#" class="add-wishlish ml-30 text-body font-sm font-heading font-weight-bold js-ai-tryon-button" data-url="{{ route('public.tryon.generate', $product->id) }}">
                <i class="fi-rs-picture mr-5"></i>{{ __('Try On (AI)') }}
            </a>
            @if (EcommerceHelper::isCompareEnabled())
